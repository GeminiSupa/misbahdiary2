        ...
        {members.length === 0 ? (
          ...
          <div className="space-y-3">
            {members.map((member) => (
              <article
                key={member.id}
                className="rounded-xl border-2 border-border/60 bg-linear-to-br from-background/80 to-background/60 px-5 py-4 shadow-sm transition-all hover:scale-[1.01] hover:shadow-md"
              >
